<h1>
  <img src="public/images/logo.png" alt="DevVault logo" width="125" style="vertical-align: middle; margin-right: 10px;" />
</h1>
...
- **APIs**: [Resource Server](https://seshatbe.up.railway.app), Google Gemini API
- **Deployment**: Netlify
- **UI Design**: Figma
...
If you’re not yet a part of [**Chingu**](https://chingu.io), we highly recommend checking it out. Chingu is a global learning community that helps aspiring developers, scrum masters, and product owners turn tutorials into real-world experience through team voyages like this one.
